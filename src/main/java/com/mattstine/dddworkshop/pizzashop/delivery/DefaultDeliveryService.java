 ...
 * @author Matt Stine
 */
final class DefaultDeliveryService implements DeliveryService {
	private final EventLog eventLog;
	private final DeliveryOrderRepository deliveryOrderRepository;
	private final OrderingService orderingService;
	private final KitchenService kitchenService;

	DefaultDeliveryService(EventLog eventLog, DeliveryOrderRepository deliveryOrderRepository, OrderingService orderingService, KitchenService kitchenService) {
